...
img = cv2.imread("Color-Detection/Data/hendrik-cornelissen--qrcOR33ErA-unsplash.jpg")
imgWidth = img.shape[1] - 40

index = ['color', 'color_name', 'hex', 'R', 'G', 'B']
df = pd.read_csv("Color-Detection/Data/colors.csv", header=None, names=index)
...
while True:
    ...
    cv2.rectangle(img, (10,10), (imgWidth, 160),(b,g,r), -1)
    text = colorname(b,g,r) + '   R=' + str(r) + ' G=' + str(g) + ' B=' + str(b)
    cv2.putText(img,text, (50,50),2, 4, (255,255,255),2,cv2.LINE_AA)    
    if(r+g+b >= 600):
